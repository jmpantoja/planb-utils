...
**AbstractDeque::clear**() : [Collection](../../../Collection.md)
...
**AbstractDeque::jsonSerialize**() : mixed[]
...
**AbstractDeque::copy**() : [Collection](../../../Collection.md)
...
**AbstractDeque::__debugInfo**() : mixed[]
...
**AbstractDeque::getIterator**() : [Traversable](../../../Traversable.md)
...
**AbstractDeque::getInnerType**() : null|[DataType](../../../DataType.md)
...
**AbstractDeque::contains**(mixed ...$values) : bool
...
**AbstractDeque::filter**(callable $callback = null) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::find**(mixed $value) : int|null
...
**AbstractDeque::findAll**(mixed $value) : mixed[]|null
...
**AbstractDeque::get**(int $index) : mixed
...
**AbstractDeque::insert**(int $index, mixed ...$values) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::map**(callable $callback) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::merge**([iterable](../../../iterable.md) $values) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::pushAll**([iterable](../../../iterable.md) $values) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::push**(mixed ...$values) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::reduce**(callable $callback, mixed|null $initial = null) : mixed
...
**AbstractDeque::remove**(int $index) : mixed
...
**AbstractDeque::reverse**() : [Sequence](../../../Sequence.md)
...
**AbstractDeque::reversed**() : [Sequence](../../../Sequence.md)
...
**AbstractDeque::rotate**(int $rotations) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::set**(int $index, mixed $value) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::slice**(int $index, int $length = null) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::sort**(callable $comparator = null) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::sorted**(callable $comparator = null) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::unshift**(mixed ...$values) : [Sequence](../../../Sequence.md)
...
**AbstractDeque::max**(callable $comparator = null) : mixed
...
**AbstractDeque::min**(callable $comparator = null) : mixed
...
**AbstractDeque::offsetExists**(mixed $offset) : bool
...
**AbstractDeque::offsetGet**(mixed $offset) : mixed
...
**AbstractDeque::offsetUnset**(mixed $offset) : void
