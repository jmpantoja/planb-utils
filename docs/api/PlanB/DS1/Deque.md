...
static **Deque::make**([iterable](../../iterable.md) $input = []) : [Collection](../../Collection.md)
...
protected **Deque::__construct**([iterable](../../iterable.md) $input = []) : 
...
protected **Deque::makeInternal**([iterable](../../iterable.md) $input) : 
...
**Deque::insert**(int $index, mixed ...$values) : 
