...
static **Set::make**([iterable](../../iterable.md) $input = []) : [Collection](../../Collection.md)
...
protected **Set::__construct**([iterable](../../iterable.md) $input = []) : 
...
protected **Set::makeInternal**([iterable](../../iterable.md) $input) : 
...
**Set::add**(mixed ...$values) : [Set](../../Set.md)
