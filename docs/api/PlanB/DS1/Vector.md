...
static **Vector::make**([iterable](../../iterable.md) $input = []) : [Collection](../../Collection.md)
...
protected **Vector::__construct**([iterable](../../iterable.md) $input = []) : 
...
protected **Vector::makeInternal**([iterable](../../iterable.md) $input) : 
...
**Vector::insert**(int $index, mixed ...$values) : 
