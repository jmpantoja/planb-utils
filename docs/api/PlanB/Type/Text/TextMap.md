...
**TextMap::clear**() : [Collection](../../../Collection.md)
...
**TextMap::copy**() : [Collection](../../../Collection.md)
...
**TextMap::getIterator**() : [Traversable](../../../Traversable.md)
...
protected **TextMap::bind**([Resolver](../../../Resolver.md) $resolver = null) : 
...
**TextMap::configure**([Resolver](../../../Resolver.md) $resolver) : void
...
**TextMap::getInnerType**() : null|[DataType](../../../DataType.md)
...
abstract protected **TextMap::makeInternal**() : [Collection](../../../Collection.md)
...
static **TextMap::make**([iterable](../../../iterable.md) $input = []) : mixed
...
abstract protected **TextMap::hook**(callable $callback, mixed ...$values) : 
...
**TextMap::offsetExists**(mixed $offset) : bool
...
**TextMap::offsetGet**(mixed $offset) : mixed
...
**TextMap::offsetSet**(mixed $offset, mixed $value) : void
...
**TextMap::offsetUnset**(mixed $offset) : void
...
**TextMap::__construct**([iterable](../../../iterable.md) $input, [Resolver](../../../Resolver.md) $resolver = null) : 
...
**TextMap::skip**(int $position) : [Pair](../../../Pair.md)
...
**TextMap::merge**(mixed[]|[Traversable](../../../Traversable.md) $values) : [Map](../../../Map.md)
...
**TextMap::intersect**([Map](../../../Map.md) $map) : [Map](../../../Map.md)
...
**TextMap::diff**([Map](../../../Map.md) $map) : [Map](../../../Map.md)
...
**TextMap::hasValue**(mixed $value) : bool
...
**TextMap::filter**(callable $callback = null) : [Map](../../../Map.md)
...
**TextMap::get**(mixed $key, mixed $default = null) : mixed
...
**TextMap::map**(callable $callback) : [Map](../../../Map.md)
...
**TextMap::pairs**() : [Sequence](../../../Sequence.md)
...
**TextMap::put**(mixed $key, mixed $value) : [Map](../../../Map.md)
...
**TextMap::putAll**([iterable](../../../iterable.md) $values) : [Map](../../../Map.md)
...
**TextMap::reduce**(callable $callback, mixed|null $initial = null) : mixed
...
**TextMap::remove**(mixed $key, mixed $default = null) : mixed
...
**TextMap::slice**(int $offset, int $length = null) : [Map](../../../Map.md)
...
**TextMap::sort**(callable $comparator = null) : [Map](../../../Map.md)
...
**TextMap::sorted**(callable $comparator = null) : [Map](../../../Map.md)
...
**TextMap::ksort**(callable $comparator = null) : [Map](../../../Map.md)
...
**TextMap::ksorted**(callable $comparator = null) : [Map](../../../Map.md)
...
**TextMap::values**() : [Sequence](../../../Sequence.md)
...
**TextMap::union**([Map](../../../Map.md) $map) : [Map](../../../Map.md)
...
**TextMap::xor**([Map](../../../Map.md) $map) : [Map](../../../Map.md)
...
**TextMap::concat**(string $delimiter = Text::BLANK_TEXT) : [Text](../../../Text.md)
