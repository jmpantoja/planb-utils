...
namespace PlanB\DS\Collection\Traits;

use PlanB\DS\Collection\Collection;
use PlanB\DS\Collection\Exception\ItemNotFoundException;
use PlanB\DS\Collection\ItemResolver;
use PlanB\DS\Collection\KeyValue;
...
trait Mutators
{
    ...
    /**
     * @var \PlanB\DS\Collection\ItemResolver
     */
     ...
     * Agrega una pareja clave/valor a la colección
     *
     * @param \PlanB\DS\Collection\KeyValue $candidate
     *
     * @return $this
     */
     ...
     *
     * @param \PlanB\DS\Collection\KeyValue $pair
     *
     * @return $this
     */
     ...
     *
     * @param \PlanB\DS\Collection\ItemResolver $resolver
     *
