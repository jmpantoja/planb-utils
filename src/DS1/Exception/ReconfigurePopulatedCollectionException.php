 ...
 */
class ReconfigurePopulatedCollectionException extends \DomainException
{
     ...
     */
    public static function make(?\Throwable $previous = null): ReconfigurePopulatedCollectionException
    {
