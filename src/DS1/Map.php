...
class Map implements \IteratorAggregate, \ArrayAccess, Collection
{
     ...
     * @return \Ds\Pair
     *
     * @throws \PlanB\DS1\UnderflowException
     */
     ...
     *
     * @param \PlanB\DS1\Map $map The other map.
     *
     * @return \PlanB\DS1\Map A new map containing the pairs of the current instance
     ...
     *
     * @param \PlanB\DS1\Map $map The map containing the keys to exclude.
     *
     * @return \PlanB\DS1\Map The result of removing all keys from the current instance
     ...
     *
     * @throws \PlanB\DS1\OutOfBoundsException if no default was provided and the key is
     ...
     * @return \PlanB\DS1\Map
     */
    public function putAll(iterable $values): Map
    {
     ...
     *
     * @param \PlanB\DS1\Map $map The other map, to combine with the current instance.
     *
     * @return \PlanB\DS1\Map A new map containing all the pairs of the current
     ...
     * map, but not of both.
     *
     * @param \PlanB\DS1\Map $map
     *
     * @return \PlanB\DS1\Map A new map containing keys in the current instance as well
